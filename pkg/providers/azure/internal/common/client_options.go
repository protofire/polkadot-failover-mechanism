...
import (
	...
	"github.com/protofire/polkadot-failover-mechanism/pkg/providers/azure/version"
...
func setUserAgent(client *autorest.Client, tfVersion, partnerID string, disableTerraformPartnerID bool) {
	...
	providerUserAgent := fmt.Sprintf("%s polkadot-failover-provider/%s", tfUserAgent, version.ProviderVersion)
