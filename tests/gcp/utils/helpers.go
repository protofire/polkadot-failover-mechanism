...
func prepareGlobalGetOp(ctx context.Context, client *compute.Service, project, opName string) getOp {
	return func(opName string) (*compute.Operation, error) {
		return client.GlobalOperations.Get(project, opName).Context(ctx).Do()
	}
}

func prepareRegionGetOp(ctx context.Context, client *compute.Service, project, region, opName string) getOp {
	return func(opName string) (*compute.Operation, error) {
...
//nolint
func prepareZoneGetOp(ctx context.Context, client *compute.Service, project, zone, opName string) getOp {
	return func(opName string) (*compute.Operation, error) {
